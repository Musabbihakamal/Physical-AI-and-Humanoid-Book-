...
def test_chunking_logic():
    ...
    print("[PASS] Chunking method works correctly")
    ...
    print("[PASS] Large text properly split into multiple chunks")
...
def test_chunk_size_update():
    ...
    print("[PASS] Chunking threshold reduced from 8000 to 6000 characters (more conservative)")
    print("[PASS] Individual chunk size reduced from 6000 to 4000 characters (more conservative)")
