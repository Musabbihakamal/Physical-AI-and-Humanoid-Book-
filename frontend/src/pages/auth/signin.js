...
function SignInWithAuth() {
  ...
  return (
    <Layout
      ...
      description="Sign in to access the Physical AI & Humanoid Robotics learning platform">
        ...
        <div className={styles.authCard}>
          ...
          <div className={styles.imageSection}>
            <div className={styles.imageSectionContent}>
              ...
              <p>Sign in to continue your journey in Physical AI & Humanoid Robotics</p>
            </div>
          </div>
          ...
          <div className={styles.formSection}>
            ...
            <p className={styles.subtitle}>Access your Physical AI & Humanoid Robotics learning materials</p>
                  ...
                  {!oauthConfig.google.configured && !oauthConfig.github.configured && !oauthConfig.google.loading && !oauthConfig.github.loading && (
                    <div className={styles.oauthDisabled}>
                      <p className="text--small text--secondary">
                        Social login is currently unavailable. Please use email and password to sign in.
                      </p>
                    </div>
                  )}
                </div>
